...
LABEL Description="The Go Programming Language docker image" Vendor="Christian González" Version="1.0.5"
LABEL Build docker build --no-cache --rm --tag christiangda/golang:1.0.5 --tag christiangda/golang:latest .
